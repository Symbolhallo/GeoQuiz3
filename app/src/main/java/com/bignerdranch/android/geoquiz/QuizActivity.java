...
public class QuizActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // ATTENTION: This was auto-generated to implement the App Indexing API.
        // See https://g.co/AppIndexing/AndroidStudio for more information.
        client5 = new GoogleApiClient.Builder(this).addApi(AppIndex.API).build();
    }
    ...
    public void onStart() {
        ...
        // See https://g.co/AppIndexing/AndroidStudio for more information.
        client5.connect();
        AppIndex.AppIndexApi.start(client5, getIndexApiAction());
    }
    ...
    public void onStop() {
        ...
        // ATTENTION: This was auto-generated to implement the App Indexing API.
        // See https://g.co/AppIndexing/AndroidStudio for more information.
        AppIndex.AppIndexApi.end(client5, getIndexApiAction());
        client5.disconnect();
    }
}
